...
- **Otomatik Güncelleme**: Uygulama açılışta en son sürümü kontrol eder. Güncelleme gerekiyorsa uygulama kapatılır, mevcut sürüm kaldırılır ve indirilen `setup.exe` çalıştırılır. Kurulum tamamlandığında uygulama otomatik olarak yeniden başlatılır. İndirilen arşiv `version.txt` içindeki SHA256 özetiyle doğrulanır, doğrulama başarısız olursa güncelleme iptal edilir.
